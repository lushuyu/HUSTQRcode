...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXIT_BROADCAST = "exitHustQR";
    ...
    private void startQrCodeActivity() {
        ...
        it.putExtra("department", conf.getString("department_preference", ""));
        startActivity(it);
    }
    ...
    protected void onResume() {
        ...
        if (conf.getString("name_preference", "").isEmpty()
                ...
                conf.getString("department_preference", "").isEmpty()) {
